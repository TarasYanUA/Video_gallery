...
Feature: Автовоспроизведение видео на всех страницах, Без иконки, Горизонтальное отображение
  ...
  Scenario Outline: Выполняем проверку Автовоспроизведения с разными типами видео
    ...
    And Выполняем проверки на витрине:
      | Видео автовоспроизводится на странице категории | y |
    ...
    Examples:
      ...
      |YouTube    |1    |@65_Autoplay02_ProductList - YouTube, Страница товара с Autoplay |@65_Autoplay02_ProductList - YouTube, Страница товара с Autoplay (RTL)   |@65_Autoplay02_ProductList - YouTube, Быстрый просмотр с Autoplay  |@65_Autoplay02_ProductList - YouTube, страница категории с Autoplay  |@65_Autoplay02_ProductList - YouTube, Страница категории с Autoplay (RTL) |
      |Vimeo      |2    |@65_Autoplay02_ProductList - Vimeo, Страница товара с Autoplay   |@65_Autoplay02_ProductList - Vimeo, Страница товара с Autoplay (RTL)     |@65_Autoplay02_ProductList - Vimeo, Быстрый просмотр с Autoplay    |@65_Autoplay02_ProductList - Vimeo, страница категории с Autoplay    |@65_Autoplay02_ProductList - Vimeo, Страница категории с Autoplay (RTL)   |
      |Ссылка     |3    |@65_Autoplay02_ProductList - Link, Страница товара с Autoplay    |@65_Autoplay02_ProductList - Link, Страница товара с Autoplay (RTL)      |@65_Autoplay02_ProductList - Link, Быстрый просмотр с Autoplay     |@65_Autoplay02_ProductList - Link, страница категории с Autoplay     |@65_Autoplay02_ProductList - Link, Страница категории с Autoplay  (RTL)   |
      |Ресурс     |4    |@65_Autoplay02_ProductList - Resource, Страница товара с Autoplay|@65_Autoplay02_ProductList - Resource, Страница товара с Autoplay (RTL)  |@65_Autoplay02_ProductList - Resource, Быстрый просмотр с Autoplay |@65_Autoplay02_ProductList - Resource, страница категории с Autoplay |@65_Autoplay02_ProductList - Resource, Страница категории с Autoplay (RTL)|
