...
Feature: Мини-иконки без галереи, Вкладки товара, Горизонтальное отображение
  ...
  Scenario Outline: Выполняем проверку на разных шаблонах товара
    ...
    Examples:
      ...
      |abt__ut2_bigpicture_flat_template      |@40.00_NoGallery01 Без галереи, Горизонтально - БК плоский          |@40.02_NoGallery01 Без галереи, Горизонтально - БК плоский (RTL)        |
      |bigpicture_template                    |@40.10_NoGallery01 Без галереи, Горизонтально - Большая картинка    |@40.12_NoGallery01 Без галереи, Горизонтально - Большая картинка (RTL)  |
      |default_template                       |@40.20_NoGallery01 Без галереи, Горизонтально - Стандартный шаблон  |@40.22_NoGallery01 Без галереи, Горизонтально - Стандартный шаблон (RTL)|
      |abt__ut2_three_columns_template        |@40.30_NoGallery01 Без галереи, Горизонтально - Трехколоночный      |@40.32_NoGallery01 Без галереи, Горизонтально - Трехколоночный (RTL)    |
      |abt__ut2_bigpicture_gallery_template   |@40.40_NoGallery01 Без галереи, Горизонтально - Галерея             |@40.42_NoGallery01 Без галереи, Горизонтально - Галереи (RTL)           |
      |abt__ut2_cascade_gallery_template      |@40.50_NoGallery01 Без галереи, Горизонтально - Каскад              |@40.52_NoGallery01 Без галереи, Горизонтально - Каскад (RTL)            |
